...
import { buildR2Key, buildCommentMarkdown } from "./storage";

describe("buildR2Key", () => {
  it.each([
    ["/dashboard", "owner/repo/pr-1/dashboard.png", "simple route"],
    ["/settings/profile", "owner/repo/pr-1/settings-profile.png", "nested route"],
...
describe("buildCommentMarkdown", () => {
  it("builds markdown with screenshots", () => {
    ...
    expect(md).toContain("![/dashboard](https://screenshots.tractorbeam.ai/o/r/pr-1/dashboard.png)");
