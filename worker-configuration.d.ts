/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 637c39b1730f0ecf880e5bbfaf7bc24d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SCREENSHOT_WORKFLOW: Workflow<Parameters<import("./src/worker/index").ScreenshotWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_WEBHOOK_SECRET" | "ANTHROPIC_API_KEY" | "INTERNAL_SECRET">> {}
}
